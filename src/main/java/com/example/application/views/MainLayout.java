 ...
 */
@PWA(name = "Raj Agro Engineering Works", shortName = "Raj Agro Engineering Works", enableInstallPrompt = false)
@Theme(themeFolder = "rajagroengineeringworks")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Raj Agro Engineering Works logo"));
        logoLayout.add(new H1("Raj Agro Engineering Works"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("Master Detail", "la la-th-list", MasterDetailView.class), //
